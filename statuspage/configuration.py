...
DATABASE = {
    'NAME': 'rsdatabase',         # Database name
    'USER': 'rs_user',               # PostgreSQL username
    'PASSWORD': 'rspassword',           # PostgreSQL password
    'HOST': 'rsdatabase.cx248m4we6k7.us-east-1.rds.amazonaws.com',      # Database server
...
REDIS = {
    'tasks': {
        'HOST': 'rs-redis.7fftml.ng.0001.use1.cache.amazonaws.com',
        'PORT': 6379,
...
SECRET_KEY = '-x7w6IC2OONDwJSv63dazfYnH6aYQ-*Um-&ScjbJDM+J=2f1rX'
